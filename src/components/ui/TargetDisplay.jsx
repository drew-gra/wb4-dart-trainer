...
export const TargetDisplay = ({ target, prefix = '', subtitle }) => (
  <div 
    className="bg-[#1c1f2e] rounded-lg p-8 text-center mb-8 shadow-2xl border-2 border-amber-500"
...
export const ScoreInputDisplay = ({ value, onChange }) => (
  ...
  >
    ...
    <input
      ...
      className="text-3xl font-bold text-center bg-[#252a3a] text-yellow-400 rounded p-3 w-32 border-2 border-amber-500 focus:border-yellow-300 focus:outline-none"
      min="2"
      max="170"
      inputMode="numeric"
    />
